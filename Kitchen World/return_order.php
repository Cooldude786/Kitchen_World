                                    ...
                                    <div class="box-body table-responsive no-padding">
                                        <table class="table table-bordered table-hover box-body" id="myTable" >
                                            ...
                                            <tbody >
                                                ...
                                                <?php
                                                $emp_query = "SELECT * FROM return_order WHERE 1 ";
                                                ...
                                                if (mysqli_num_rows($employeesRecords) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($employeesRecords)) {
                                                        ...
                                                        <tr>
                                                          <td><?php echo $id ;?></td>
                                                          <td><a href="single_return.php?order=<?php echo $ord_id ;?>"><?php echo $ord_id ;?></a></td>

                                                       <?php
                                                          $sql1 = "select * from address where `id`= '" . $address . "' ";
                                                        ...
                                                        <td ><?php echo $payment_type;?></td>
                                                         <td><h4  style="color:#3c763d;" ><i class="fa fa-check-circle-o" aria-hidden="true"><?php echo  $Status ?></i></h4></td>
                                                         <td><?php echo $date;?></td>
                                                       <!--
